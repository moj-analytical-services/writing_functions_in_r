...
If you still wanted to use the `group_by` and `summarise` functions in a user-defined function, then variables containing the column names as strings can be enclosed by `!!as.name()` to convert them into names, like so:
