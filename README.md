...
All the examples in the presentation/README are available in the R script example\_code.R.
...
Any value can be used as a default value for an argument. For example, we can generalise the `sum_squares()` function by allowing it to sum together two numbers raised to any power, but have a default power of 2:
...
Example 9: a "real-world" example
---------------------------------
