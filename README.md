...
Any value can be used as a default value for an optional argument. For example, we can generalise the sum_squares function above by allowing it to sum together two numbers raised to any power, but have a default power of 2:
