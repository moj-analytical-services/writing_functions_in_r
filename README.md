...
```
    ...
    ## $ Type.of.Defendent         <chr> "01: Person", "01: Person", "01: Person", "01: Person", "01: Person", "…
    ## $ Age.Group                 <chr> "01: Juveniles", "01: Juveniles", "01: Juveniles", "01: Juveniles", "01…
    ## $ Age.Range                 <chr> "01: 10-11", "01: 10-11", "01: 10-11", "01: 10-11", "01: 10-11", "01: 1…
    ## $ Ethnicity                 <chr> "N/A", "N/A", "N/A", "N/A", "N/A", "N/A", "N/A", "N/A", "N/A", "N/A", "…
    ## $ Court.Type                <chr> "Magistrates Court", "Magistrates Court", "Magistrates Court", "Magistr…
    ## $ Offence.Type              <chr> "01 Indictable only", "01 Indictable only", "01 Indictable only", "01 I…
    ## $ Offence.Group             <chr> "02 Sexual offences", "03 Robbery", "03 Robbery", "07 Possession of wea…
    ## $ Tried                     <chr> "5: Not tried", "01: Tried at magistrates court", "01: Tried at magistr…
    ## $ Plea.at.the.Crown.Court   <chr> "N/A", "N/A", "N/A", "N/A", "N/A", "N/A", "N/A", "N/A", "N/A", "N/A", "…
    ## $ Convicted..Not.convicted  <chr> "02: Not convicted", "01: Convicted", "02: Not convicted", "01: Convict…
    ## $ Sentenced...Not.sentenced <chr> "02: Not sentenced", "01: Sentenced", "02: Not sentenced", "01: Sentenc…
    ## $ Outcome                   <chr> "01: Proceedings terminated early", "07: Found guilty", "03: Dismissed …
    ## $ Count                     <int> 1, 6, 1, 1, 10, 1, 1, 1, 31, 1, 3, 15, 1, 5, 2, 1, 1, 4, 2, 85, 2, 20, …
...
like “01: Juveniles” rather than just “Juveniles”.
    ...
    ## Rows: 107,493
    ## Columns: 10
    ## $ year              <int> 2008, 2008, 2008, 2008, 2008, 2008, 2008, 2008, 2008, 2008, 2008, 2008, 2008, 2…
    ## $ quarter           <chr> "Q1", "Q1", "Q1", "Q1", "Q1", "Q1", "Q1", "Q1", "Q1", "Q1", "Q1", "Q1", "Q1", "…
    ## $ sex               <chr> "01: Male", "01: Male", "01: Male", "01: Male", "01: Male", "01: Male", "01: Ma…
    ## $ type_of_defendent <chr> "01: Person", "01: Person", "01: Person", "01: Person", "01: Person", "01: Pers…
    ## $ age_group         <chr> "01: Juveniles", "01: Juveniles", "01: Juveniles", "01: Juveniles", "01: Juveni…
    ## $ age_range         <chr> "01: 10-11", "01: 10-11", "01: 10-11", "01: 10-11", "01: 10-11", "01: 10-11", "…
    ## $ ethnicity         <chr> "N/A", "N/A", "N/A", "N/A", "N/A", "N/A", "N/A", "N/A", "N/A", "N/A", "N/A", "N…
    ## $ court_type        <chr> "Magistrates Court", "Magistrates Court", "Magistrates Court", "Magistrates Cou…
    ## $ offence_type      <chr> "01 Indictable only", "01 Indictable only", "01 Indictable only", "01 Indictabl…
    ## $ offence_group     <chr> "02 Sexual offences", "03 Robbery", "03 Robbery", "07 Possession of weapons", "…
...
```
    ...
    ## Rows: 107,493
    ## Columns: 16
    ## $ year                    <int> 2008, 2008, 2008, 2008, 2008, 2008, 2008, 2008, 2008, 2008, 2008, 2008, 2…
    ## $ quarter                 <chr> "Q1", "Q1", "Q1", "Q1", "Q1", "Q1", "Q1", "Q1", "Q1", "Q1", "Q1", "Q1", "…
    ## $ sex                     <chr> "Male", "Male", "Male", "Male", "Male", "Male", "Male", "Male", "Male", "…
    ## $ type_of_defendent       <chr> "Person", "Person", "Person", "Person", "Person", "Person", "Person", "Pe…
    ## $ age_group               <chr> "Juveniles", "Juveniles", "Juveniles", "Juveniles", "Juveniles", "Juvenil…
    ## $ age_range               <chr> "10-11", "10-11", "10-11", "10-11", "10-11", "10-11", "10-11", "10-11", "…
    ## $ ethnicity               <chr> "N/A", "N/A", "N/A", "N/A", "N/A", "N/A", "N/A", "N/A", "N/A", "N/A", "N/…
    ## $ court_type              <chr> "Magistrates Court", "Magistrates Court", "Magistrates Court", "Magistrat…
    ## $ offence_type            <chr> "Indictable only", "Indictable only", "Indictable only", "Indictable only…
    ## $ offence_group           <chr> "Sexual offences", "Robbery", "Robbery", "Possession of weapons", "Violen…
    ## $ tried                   <chr> "Not tried", "Tried at magistrates court", "Tried at magistrates court", …
    ## $ plea_at_the_crown_court <chr> "N/A", "N/A", "N/A", "N/A", "N/A", "N/A", "N/A", "N/A", "N/A", "N/A", "N/…
    ## $ convicted_not_convicted <chr> "Not convicted", "Convicted", "Not convicted", "Convicted", "Convicted", …
    ## $ sentenced_not_sentenced <chr> "Not sentenced", "Sentenced", "Not sentenced", "Sentenced", "Sentenced", …
    ## $ outcome                 <chr> "Proceedings terminated early", "Found guilty", "Dismissed (found not gui…
...
```
    ...
    ## $ age_group               <chr> "Juveniles", "Juveniles", "Juveniles", "Juveniles", "Juveniles", "Juvenil…
    ## $ age_range               <chr> "10-11", "10-11", "10-11", "10-11", "10-11", "10-11", "10-11", "10-11", "…
    ## $ ethnicity               <chr> "Not known", "Not known", "Not known", "Not known", "Not known", "Not kno…
    ## $ court_type              <chr> "Magistrates Court", "Magistrates Court", "Magistrates Court", "Magistrat…
    ## $ offence_type            <chr> "Indictable only", "Indictable only", "Indictable only", "Indictable only…
    ## $ offence_group           <chr> "Sexual offences", "Robbery", "Robbery", "Possession of weapons", "Violen…
    ## $ tried                   <chr> "Not tried", "Tried at magistrates court", "Tried at magistrates court", …
    ## $ plea_at_the_crown_court <chr> "Not known", "Not known", "Not known", "Not known", "Not known", "Not kno…
    ## $ convicted_not_convicted <chr> "Not convicted", "Convicted", "Not convicted", "Convicted", "Convicted", …
    ## $ sentenced_not_sentenced <chr> "Not sentenced", "Sentenced", "Not sentenced", "Sentenced", "Sentenced", …
    ## $ outcome                 <chr> "Proceedings terminated early", "Found guilty", "Dismissed (found not gui…
    ## $ count                   <int> 1, 6, 1, 1, 10, 1, 1, 1, 31, 1, 3, 15, 1, 5, 2, 1, 1, 4, 2, 85, 2, 20, 4,…
...
```
    ...
    ## Rows: 14,929
    ## Columns: 17
    ## $ year                    <int> 2017, 2017, 2017, 2017, 2017, 2017, 2017, 2017, 2017, 2017, 2017, 2017, 2…
    ## $ quarter                 <chr> "Q2", "Q2", "Q2", "Q2", "Q2", "Q2", "Q2", "Q2", "Q2", "Q2", "Q2", "Q2", "…
    ## $ sex                     <chr> "Male", "Male", "Male", "Male", "Male", "Male", "Male", "Male", "Male", "…
    ## $ type_of_defendent       <chr> "Person", "Person", "Person", "Person", "Person", "Person", "Person", "Pe…
    ## $ age_group               <chr> "Juveniles", "Juveniles", "Juveniles", "Juveniles", "Juveniles", "Juvenil…
    ## $ age_range               <chr> "10-11", "10-11", "10-11", "10-11", "10-11", "10-11", "10-11", "10-11", "…
    ## $ ethnicity               <chr> "White", "White", "White", "White", "White", "Not known", "Not known", "N…
    ## $ court_type              <chr> "Magistrates Court", "Magistrates Court", "Magistrates Court", "Magistrat…
    ## $ offence_type            <chr> "Indictable only", "Triable either way", "Triable either way", "Triable e…
    ## $ offence_group           <chr> "Robbery", "Violence against the person", "Theft Offences", "Criminal dam…
    ## $ tried                   <chr> "Tried at magistrates court", "Tried at magistrates court", "Not tried", …
    ## $ plea_at_the_crown_court <chr> "Not known", "Not known", "Not known", "Not known", "Not known", "Not kno…
    ## $ convicted_not_convicted <chr> "Convicted", "Convicted", "Not convicted", "Convicted", "Convicted", "Con…
    ## $ sentenced_not_sentenced <chr> "Sentenced", "Sentenced", "Not sentenced", "Sentenced", "Sentenced", "Sen…
    ## $ outcome                 <chr> "Found guilty", "Found guilty", "Proceedings terminated early", "Found gu…
    ## $ count                   <int> 1, 1, 1, 1, 1, 1, 1, 1, 8, 7, 2, 2, 3, 1, 5, 9, 1, 1, 5, 2, 1, 1, 2, 1, 1…
    ## $ year_quarter            <chr> "2017 Q2", "2017 Q2", "2017 Q2", "2017 Q2", "2017 Q2", "2017 Q2", "2017 Q…
