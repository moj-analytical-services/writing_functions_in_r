...
+ You have cloned this repository:
        + If you have used GitHub and the Analytical Platform before, follow the instructions in [section 3.2.1 of the Platform User Guidance](https://moj-analytical-services.github.io/platform_user_guidance/github.html#r-studio).
        + If you have not used GitHub with the Analytical Platform before, you might need to set this up using the instructions in [section 1.5 of the Platform User Guidance](https://moj-analytical-services.github.io/platform_user_guidance/introduction.html#configure-git-and-github), before following the instructions in section 3.2.1 as above.
