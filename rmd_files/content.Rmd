...
1. Add the below assertion to `pythagorus()` in the correct place to test the output object.
2. Add a message that would tell the developer why the assertion is not being passed.
3. Modify the function so that the assertion passes and the function succeeds.
