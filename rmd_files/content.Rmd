...
This function uses `lapply()` to apply a function to all columns in the dataframe. Here we've used an "anonymous function" as the second argument of `lapply()`, which is a single-use function that doesn't have a name.
