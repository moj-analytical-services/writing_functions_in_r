...
### Before we start
To follow along with the code run during this session and participate in the exercises, open the script "example_code.R" in RStudio. You may also want to have the course [read me](https://github.com/moj-analytical-services/writing_functions_in_r) open as a reference.
...
```
---
If you run `pick_a_colour` without brackets, it will print the function code to the console:
```{r}
pick_a_colour
```
