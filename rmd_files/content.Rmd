...
The name of a function should give you a good idea of what it does. A good rule of thumb is to begin with a verb and be concise, for example. `read_data()`, `remove_duplicates()`, `standardise_dates()`.
...
It often helpful to keep your functions separate from the rest of your code to make them easier to find and reuse.
