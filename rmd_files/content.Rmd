...
1. Add the below assertion to `pythagorus()` in the correct place to test the value that is reported.
2. Add a message that would report why the assertion is not being passed.
